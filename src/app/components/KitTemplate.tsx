export default class KitTemplate {
  delay = `
        <delay 
            pingPong="1"
            analog="0"
  ...
  sound_source_template(input_data: SampleData) {
  ...
  sound_sources(sample_data_array_input: SampleData[]) {
  ...
  finalKit(sample_data_array_input: SampleData[]) {
    console.log(sample_data_array_input);
    return `
    <kit
